...
/**
 * Class creates a window for entering id of product to be deleted from database
 * Window will appear in when in the 'Admin' menu, 'Delete product' button was pressed
 * @author Timi
 *
 */
@SuppressWarnings("serial")
public class DeleteProductFrame extends JFrame{
	private JLabel l1 = new JLabel ("Product ID: ");
